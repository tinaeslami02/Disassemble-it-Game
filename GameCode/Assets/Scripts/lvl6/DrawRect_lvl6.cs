...
public class DrawRect_lvl6 : MonoBehaviour
{
    //[SerializeField]
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButton(1))
        {
            ...
            //RestClient.Put("https://unitygame-83bfb-default-rtdb.firebaseio.com/" + FireBaseName.playerName + "/sprite" + level6_img_exampleclass.generatedNum + "/x0,x1,y0,y3" + ".json", new Vector2(initialMousePosition.x, initialMousePosition.y));
            //RestClient.Put("https://unitygame-83bfb-default-rtdb.firebaseio.com/" + FireBaseName.playerName + "/sprite" + level6_img_exampleclass.generatedNum + "/x2,x3,y1,y2" + ".json", new Vector2(currentMousePosition.x, currentMousePosition.y));
            RestClient.Put("https://unitygame-83bfb-default-rtdb.firebaseio.com/" + FireBaseName.playerName + "/sprite" + level6_img_exampleclass.generatedNum + "/xmax,xmin" + ".json", new Vector2(currentMousePosition.x, initialMousePosition.x));
            RestClient.Put("https://unitygame-83bfb-default-rtdb.firebaseio.com/" + FireBaseName.playerName + "/sprite" + level6_img_exampleclass.generatedNum + "/ymax,ymin" + ".json", new Vector2(currentMousePosition.y, initialMousePosition.y));
        }
